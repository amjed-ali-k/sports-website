...
export default function RegistrationsPage() {
  ...
  const { data: registrations, isLoading: registrationsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`/api/registrations?itemId=${selectedItem.id}`);
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Enter additional information" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  <div className="grid grid-cols-2 gap-4 max-h-[400px] overflow-y-auto">
                    {filteredParticipants?.map((participant: any) => (
                      <Card
                        ...
                        onClick={() => {
                          const newSelected = selectedParticipants.includes(participant.id)
